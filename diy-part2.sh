...
echo "===== Configure Samba share on overlay ====="

# 创建共享目录
mkdir -p files/root/download

# 创建开机初始化脚本
mkdir -p files/etc/init.d

cat > files/etc/init.d/nas-share <<'EOF'
...
chmod +x files/etc/init.d/nas-share
...
echo "===== Samba overlay share created ====="
